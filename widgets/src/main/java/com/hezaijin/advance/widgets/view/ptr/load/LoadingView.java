...
public class LoadingView extends RelativeLayout {
    ...
    private static final int CIRCLE_DIAMETER_Big = 100;
  ...
  /*  public LoadingView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void createProgressView() {
        ...
        mCircleView.setLayoutParams(new RelativeLayout.LayoutParams(LayoutParams.MATCH_PARENT,LayoutParams.MATCH_PARENT));
        /*创建加载动画Drawable*/
        ...
        /*设置加载时的颜色值*/
        mProgress.setColorSchemeColors(0xFC03A9F4);
        addView(mCircleView);
    }
